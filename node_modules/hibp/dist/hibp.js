(function (global, factory) {
  ...
  (global = global || self, factory(global.hibp = {}));
  ...
  var TOO_MANY_REQUESTS = {
      headers: {},
      status: 429,
      data: 'Rate limit exceeded, refer to acceptable use of the API: ' + 'https://haveibeenpwned.com/API/v2#AcceptableUse'
  };
  ...
  var fetchFromApi = (function (endpoint) {
      ...
      return function () {
          ...
          return Promise.resolve(axios$2.get(endpoint, config)).then(function (res) {
              return res.data;
          }).catch(function (err) {
              if (err.response) {
   ...
   * @alias module:breach
   */
  var breach = function breach(breachName) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
   ...
   */
  var breaches = function breaches() {
   ...
   */
  var fetchFromApi$1 = (function (endpoint) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return function () {
          var baseUrl = options.baseUrl, userAgent = options.userAgent;
          var config = Object.assign({}, baseUrl ? {
          ...
          return Promise.resolve(axios$3.get(endpoint, config)).then(function (res) {
              return res.data;
          }).catch(function (err) {
              if (err.response) {
                  switch (err.response.status) {
   ...
   */
  var pwnedPasswordRange = function pwnedPasswordRange(prefix) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return fetchFromApi$1("/range/".concat(encodeURIComponent(prefix)), options) // create array from lines of text in response body
          .then(function (data) {
          return data.split('\n');
  ...
  var pwnedPassword = function pwnedPassword(password) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var sha1$$1 = new sha1('SHA-1', 'TEXT');
      sha1$$1.update(password);
      var hash = sha1$$1.getHash('HEX', {
          outputUpper: true
      });
  ...
  var search = function search(account) {
      ...
      return function () {
          var baseUrl = breachOptions.baseUrl, userAgent = breachOptions.userAgent;
          return Promise.all([breachedAccount(account, breachOptions),
              /^.+@.+$/.test(account) ? pasteAccount(account, {
                  baseUrl: baseUrl,
                  userAgent: userAgent
              }) : null]).then(function (_ref) {
              var _ref2 = _slicedToArray(_ref, 2), breaches = _ref2[0], pastes = _ref2[1];
              return {
                  breaches: breaches,
                  pastes: pastes
              };
